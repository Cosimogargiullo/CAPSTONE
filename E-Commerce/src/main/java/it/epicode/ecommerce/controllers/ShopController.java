...
import it.epicode.ecommerce.common.utils.AppRunner;
...
//	GET SHOP BY ID
	...
	public ResponseEntity<Shop> findById(@PathVariable(required = true) Long id) {
		try {
			Optional<Shop> find = shopService.findById(id);
...
//	SING UP FUNCTION
	@PostMapping(path = "/shop/{id}")
	public ResponseEntity<Shop> singupUser(@RequestBody Shop shop, @PathVariable(required = true) Long id) throws EcommerceExceptionNotValid {
		Shop save = shopService.createShop(shop, id);
		return new ResponseEntity<>(save, HttpStatus.OK);
	}
	
//	CREATE POST
//	@PostMapping(path = "/shopcreate")
//	public ResponseEntity<Product> createPosts() throws EcommerceExceptionNotValid, EcommerceExceptionNotFound {
